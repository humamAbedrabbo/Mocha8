...
namespace AMS.Controllers
{
    ...
    public class UserGroupsController : Controller
    {
        ...
        public UserGroupsController(AmsContext context)
        {
            _context = context;
        }
        ...
        {
            var amsContext = _context.UserGroups.Include(u => u.Tenant);
        ...
        public async Task<IActionResult> Create([Bind("Id,TenantId,Name")] UserGroup userGroup)
        {
            ...
            ViewData["TenantId"] = new SelectList(_context.Tenants, "Id", "Name", userGroup.TenantId);
            return View(userGroup);
        }
